...
This project is indexed by GitNexus as **vimeo-brain** (30 symbols, 27 relationships, 0 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
...
3. `READ gitnexus://repo/vimeo-brain/process/{processName}` — trace the full execution flow step by step
...
| Resource | Use for |
|----------|---------|
| `gitnexus://repo/vimeo-brain/context` | Codebase overview, check index freshness |
| `gitnexus://repo/vimeo-brain/clusters` | All functional areas |
| `gitnexus://repo/vimeo-brain/processes` | All execution flows |
| `gitnexus://repo/vimeo-brain/process/{name}` | Step-by-step execution trace |
